...
- You may **not** use (and will not need) Excel, Python, or calculator
- Questions will be a mix of true/false, multiple choice, and short answer
- Practice problems available on Canvas.
- Please study beforehand and then use the practice problems to gauge understanding.
