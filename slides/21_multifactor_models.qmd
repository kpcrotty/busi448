---
title: 'Modern Asset Pricing Models'
...
- For a given stock, we need two ingredients to construct an expected return estimate.
...
## {background-iframe="http://bbcx-investments.com/factor-investing/ff-costequity" background-interactive="True"}
...
3. Expected return estimate $\tau$ is: $$E[R_{i\tau}] = R_{f\tau} +  \sum_{j=1}^N \overline{b}_{j} \cdot \text{characteristic}_{i\tau-1} $$
